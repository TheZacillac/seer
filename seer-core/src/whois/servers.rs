...
pub static WHOIS_SERVERS: Lazy<HashMap<&'static str, &'static str>> = Lazy::new(|| {
    ...
    m.insert("hiv", "whois.tucowsregistry.net");
    ...
    m.insert("lifestyle", "whois.tucowsregistry.net");
    ...
    m.insert("living", "whois.tucowsregistry.net");
    ...
    m.insert("trust", "whois.tucowsregistry.net");
    ...
    m.insert("vana", "whois.tucowsregistry.net");
    ...
    m.insert("xn--30rr7y", "whois.zdns.cn");
    m.insert("xn--3bst00m", "whois.zdns.cn");
    ...
    m.insert("xn--45q11c", "whois.zdns.cn");
    ...
    m.insert("xn--6qq986b3xl", "whois.zdns.cn");
    ...
    m.insert("xn--9et52u", "whois.zdns.cn");
    ...
    m.insert("xn--czru2d", "whois.zdns.cn");
    ...
    m.insert("xn--hxt814e", "whois.zdns.cn");
    ...
    m.insert("中信", "whois.gtld.knet.cn");
